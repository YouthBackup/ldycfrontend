...
<template>
  <div class="px-1 sm:px-4 py-2">
    <div
      class="w-full m-auto p-6 md:p-10 bg-white shadow-xl rounded-3xl transition-all duration-300"
      :class="participants.length ? 'max-w-5xl' : 'max-w-[650px]'"
    >
      <h2 class="mb-2 font-bold text-2xl text-center text-black">
        Manual Registration
      </h2>
      <p class="mb-8 text-center text-sm text-slate-500">
        Register one or more participants directly. No payment is required.
      </p>
      ...
      >
        ...
        >
          ...
          <div class="border border-gray-200 rounded-2xl p-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <select
                  ...
                  class="mt-2 w-full py-2.5 px-4 h-11 bg-transparent border border-gray-200 rounded-xl focus:ring-2 focus:ring-ldyc-blue focus:border-ldyc-blue transition-colors"
                >
                  <option
                    disabled
                    value=""
              ...
              >
                ...
                <select
                  ...
                  class="mt-2 w-full py-2.5 px-4 h-11 bg-transparent border border-gray-200 rounded-xl focus:ring-2 focus:ring-ldyc-blue focus:border-ldyc-blue transition-colors disabled:cursor-not-allowed"
              ...
              <div class="sm:col-span-2">
                ...
                >
                  ...
                  <template v-else>
                    ...
                    />
                    <span
                      class="max-w-full truncate text-xs font-medium text-slate-600"
                    >
            ...
            <div class="mt-6">
              ...
              <p class="mt-2 text-xs text-center text-slate-500">
                Registering just one person? Skip this and hit "Register" below.
              </p>
            </div>
          </div>
          ...
          <div
            ...
            class="border border-gray-200 rounded-2xl p-4 lg:sticky lg:top-6"
          >
            <h3 class="font-semibold text-black mb-3 text-sm">
            ...
            <ul class="space-y-2">
              <li
                ...
                :key="index"
                class="flex items-center justify-between gap-2 p-2.5 rounded-lg bg-slate-50"
              >
                <div class="min-w-0">
    ...
    >
      <div
        class="bg-white rounded-3xl p-6 w-full max-w-lg shadow-2xl"
      >
        <h3 class="font-bold text-lg mb-4 text-center text-black">
          Youth Summer Conference Disclaimer and <br />
          Code of Conduct Agreement
        </h3>
        <div
          class="text-sm text-slate-600 max-h-60 overflow-y-auto"
        >
          <p>
          ...
          <div>
            <h4 class="text-base font-bold mt-3 text-black">
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await registerParticipants(allParticipants, photos);
    toast.success("Participant(s) registered successfully.", {
      position: "top-right",
      duration: 5000,
    });
    resetForm();
...
const registerParticipants = async (allParticipants, photos) => {
  ...
  return await store.dispatch("registerDirect", formData);
};
