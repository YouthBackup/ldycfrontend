<template>
  ...
  <navbar
    ...
    :nav-light="true"
    :search-menu="'text-white'"
  />
  <!-- Hero Start -->
  <section
    class="relative py-36 bg-cover jarallax"
    :style="{
        ...
        <div class="lg:col-span-7">
          ...
          <!-- <div class="mt-6">
            ...
            <a
              ...
              data-type="youtube"
              data-id="S_CGed6E610"
              class="size-10 cursor-pointer inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border border-red-500 bg-red-500 text-white ms-1 lightbox"
              ...
              <div class="grid grid-cols-1 gap-3">
                <div>
                  ...
                  <div class="relative mt-2">
                    <i
                      data-feather="search"
                      class="size-[18px] absolute top-[10px] start-3"
                    ></i>
                    <input
                      name="name"
                      type="text"
                ...
                <div>
                  ...
                  <div class="relative mt-2">
                    ...
                    ></i>
                    <select
                      class="form-select w-full py-2 px-3 ps-10 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-md outline-none border border-gray-100 dark:border-gray-800 focus:ring-0"
                    >
  ...
  <div class="relative">
    <div class="absolute block w-full h-auto bottom-[25px] z-1 start-0">
      ...
      ><i
        class="mdi mdi-arrow-down absolute top-0 start-0 end-0 text-center inline-flex items-center justify-center rounded-full bg-white dark:bg-slate-900 h-12 w-12 mx-auto shadow-md dark:shadow-gray-800"
      /></a>
    </div>
...
// import destinations from "@/components/destinations/destinations-slider.vue";
// import packages from "@/components/tour-packages/tour-packages-8item.vue";
// import users from "@/components/users.vue";
// import askedquestions from "@/components/asked-questions.vue";
import fooTer from "@/components/footer.vue";
// import VueDatePicker from "@vuepic/vue-datepicker";
// import "@vuepic/vue-datepicker/dist/main.css";
import backgroundImagePath from "../../assets/images/bg/6.jpg";
